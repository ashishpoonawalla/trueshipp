    ...
    // if ($hash != $posted_hash) {
      if ($hash == null || $hash == "" ) {
        echo "Invalid Transaction. Please try again";
         ...
         echo "<h3>Your payment status is ". $status .".</h3><br>";
         echo "You may try making the payment by clicking the link below.</h4><br><br>";
         
      } 
?>

<br><br><a href='my_rent.php' style="color: skyblue; " >Click here to proceed to rent / sale booking page.</a>
