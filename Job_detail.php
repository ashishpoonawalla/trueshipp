...
<?php
      ...
      //echo $sql1; 
          ...
          $PCity11 =$PCity =$row1['PCity'];
          $DCity11 =$DCity =$row1['DCity'];
          $Pdate = $row1['PDate'];
          $Ddate = $row1['DDate'];
...
<section class="section-sm">
    ...
    <!-- slider end--------------------------------------------------- -->
            ...
            <div class="col-md-6 mb-4">
              <!-- course thumb -->
              <div id='myMap' style='width: 100%; height: 100%; min-height:250px; max-height:250px;'></div>
              <div id='directionsItinerary' style='width: 100%; overflow:scroll; height: 100%; min-height:200px; max-height:200px;'></div>
            </div>
...
<section class="section-sm" >
  <div class="container" >
    ...
    $sql1="SELECT * FROM products Where typepost='JOB' AND product_id<>$pid1 AND  status1='Posted' ORDER BY product_id DESC Limit 12" ;
