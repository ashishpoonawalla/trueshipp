  ...
  if ($rowcnt < 8 )
  {
    for ($ff = 1; $ff<= (12-$rowcnt); $ff++){
      echo "<br><br>";
        ...
        <div style="padding: 5px; width: 350px; height:470px; overflow-y: scroll; border: solid 2px #ddd; position: fixed; right: 0;bottom: 0; background-color: white; z-index: 300;"    >
