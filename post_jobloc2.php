      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb">
            <li class="list-inline-item"><a class="h3 text-primary font-secondary" href="#">Post Job - Set Drop Location</a></li>
          </ul>
      ...
      <div class="row">
        <div class="col-lg-12 mb-4 mb-lg-0">
			...
			<!-- <div id="myMap" style="position:relative;width:100%;height:350px;"></div>
              ...
              <form action="post_jobloc2_code.php" method="post">
                <input type="hidden" id="pid" name="pid" value="<?php echo $pid; ?>">
                <input type="text" id="lat2" name="lat2" required>
                <input type="text" id="lon2" name="lon2" required>

                <br><br>
                <button type="submit" value="send" class="btn btn-primary">Next -> Submit & Finish </button>
		 ...
		 <!-- --------------------------------- New Map Code -------------- -->
                ...
                <form action="post_jobloc2_code.php" method="post">
                  ...
                  <button type="submit" value="send" class="btn btn-primary btn-sm">Submit & Finish </button>
...
<!-- <script type='text/javascript'>
    ...
    function GetMap() {
        ...
        document.getElementById('lat2').value = center.latitude.toString();
        document.getElementById('lon2').value = center.longitude.toString();
    ...
    function highlight(id, event) {
        ...
        document.getElementById('lat2').value = event.target.getLocation().latitude.toString();
        document.getElementById('lon2').value = event.target.getLocation().longitude.toString();
