  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
       ...
       <!-- <a class="h3 text-primary font-secondary form-group mx-sm-2" href="#">
...
<!-- Category List ---------------------------------------- -->
      ...
      <nav class="navbar navbar-light navbar-expand-sm " id="myNavbar">        
        
        <div class="navbar-header " id="mainNav">
          <ul class="navbar-brand ml-auto nav-fill">
                
          <li class="nav-item px-4 dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="servicesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff;">All Categories</a>
            ...
            <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Automobiles</b></div>
                  <?php
                    ...
                    while($row1 = $result1->fetch_assoc())
                    {
                        ...
                        ?>
                    <a class="dropdown-item" href="#" style="font-size: 12px; padding: 4px;"><?php echo $cat; ?></a>
                        <?php
                    }
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Big Items</b></div>
                  <?php
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Furniture</b></div>
                  <?php
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Machinery</b></div>
                  <?php
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>House Items</b></div>
                  <?php
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Pets</b></div>
                  <?php
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Rent Category</b></div>
                  <?php
              ...
              <div>   
                <div class="dropdown-header" style="font-size: 12px; padding: 4px;padding-bottom: 10px; "><b>Sale Category</b></div>
                  <?php
...
<section class="section-sm">
  ...
  <?php   
    ...
    <div class="row">
      ...
      <a href="index.php?pgcntplus=12" class="btn btn-sm btn-primary-outline ">see more</a>
      </div>
    </div>
  ...
  <div class="container">
      ...
      <div class="col-12 mb-4">
          ...
          <div class="col-12 px-0">
            <h3 class="section-title text-primary">Shipping categories</h3>
            <div class="row">
              <div class="col-md-2">
