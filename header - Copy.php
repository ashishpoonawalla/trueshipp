      ...
      <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark p-0">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto text-center " style="border-bottom-left-radius: 20px; ">
              ...
              <li class="nav-item dropdown view">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  if (isset($_SESSION["uname"])) {
                    $un = $_SESSION["uname"];
                  ?>
                    <img src="./assets/imagesu/<?php echo $un; ?>.jpg?t=<?php echo filemtime('./assets/imagesu/' . $un . '.jpg'); ?>" style="height: 20px;border-radius:30px;">&nbsp;
                  <?php
              ...
              <li class="nav-item dropdown view">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  ?>
                    ...
                    <a class="dropdown-item" href="Job_detail.php?jobid=<?php echo $pid1; ?>"><?php echo $st1; ?> # <?php echo $PCity; ?> - <?php echo $DCity; ?></a>
              ...
              ?>
                  ...
                  <li class="nav-item dropdown view">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <span <?php if ($cnt112 == 0) { ?> class="badge badge-success" <?php } else {  ?> class="badge badge-danger" <?php } ?> style="position:absolute ;margin-top: -8px; margin-left: -11px; font-size: 10px; border-radius: 10px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <?php
                      require('db.php');
                      $sql112 = "SELECT * FROM notifications Where ruid='$un24' AND status1='N' limit 10";
                  ...
                  <li class="nav-item @@blog">
                    ...
                    ?>
                      <a class="nav-link" href="message.php"><img src="images/Message-box.png" style="margin-top: -2px;">
                        <span <?php if ($cnt112 == 0) { ?> class="badge badge-success" <?php } else {  ?> class="badge badge-danger" <?php } ?> style="position:absolute ;margin-top: -8px; margin-left: -8px; font-size: 10px;  border-radius: 10px;">
                ...
                <li class="nav-item dropdown view">
                  ...
                  -->
                    ...
                    ?>
                      ...
                      <a class="dropdown-item text-info" href="my_rent.php">Rent / Buy</a>
