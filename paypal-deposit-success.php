...
<section class="mbr-section" id="terms-header3-0">
    <div class="mbr-section__container container mbr-section__container--first">
        <div class="mbr-header mbr-header--wysiwyg row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="mbr-header__text">Paypal Payment Successful - Order Booked</h3>
                <p class="mbr-header__subtext">trueshipp</p>
            </div>
        </div>
    </div>
</section>

<section class="engine"><a rel="external" href="https://mobirise.com">best drag and drop website building software</a></section><section class="mbr-section" id="terms-content1-0">
