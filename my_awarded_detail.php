      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb">
            <li class="list-inline-item"><a class="h3 text-primary font-secondary" href="#">Awarded Job</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mb-4">
          <!-- course thumb -->
          <img src="assets/images/<?php echo $jobid; ?>_1.png" class="img-fluid w-100">
