    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
		  ...
		  ** Upload image -> Click Next<br><br>
          <p class="mb-5">
		  	<!-- <a href="post_jobfinish.php?jobid=<?php echo $pid; ?>" class="btn btn-primary">Next -> Set Pickup Location</a> -->
			<a href="post_jobloc1.php?jobid=<?php echo $pid; ?>" class="btn btn-primary">Next -> Set Pickup Location</a>
		  </p>
