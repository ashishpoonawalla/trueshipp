  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <button href="#" data-toggle="modal" data-target="#postModal3" class="btn btn-primary  mx-sm-3 float-left" style="height: 40px; padding-top: 11px; padding-left: 25px; width: 50px; margin-right: 4px;"><i class="ti-location-pin mr-1 "></i> </button> 
        ...
        <form class="form-inline" action="#" method="GET">
          ...
          <div class="form-group mx-sm-2">
            <input type="text" class="form-control" style="width: 200px; height: 40px;" name="Key1" value="<?php echo $Key1 ?>" placeholder="">
          </div>
