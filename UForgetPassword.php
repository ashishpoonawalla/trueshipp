      ...
      <div class="row">
        ...
        <?php 
          ...
          if(isset (	$_POST['uemail'])){
            ...
            $sql="UPDATE user_info SET codepass='$verifycode' Where email='$fpuname'" ;
            ...
            if ($conn->query($sql) === TRUE) {
              ...
              echo "Code sent to email. It'll take few minutes to got email.<br><br><a href='UPasswordRecovery.php'>Click here to recover your password</a>";
