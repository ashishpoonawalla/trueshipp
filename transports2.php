 ...
 //  $sql1="SELECT * FROM seller_info $Query1 ORDER BY product_id DESC Limit 10" ;		
  ...
  <div class="row">
    <div class="col-lg-4 mb-4 mb-lg-0">
      ...
      <img src='./assets/imagesu/<?php echo $unm1; ?>.jpg?t=<?php echo filemtime('./assets/imagesu/'.$unm1.'.jpg'); ?>' style=" max-height: 150px; border: 4px solid #aaa; padding: 2px; border-radius: 5px;" />
        <br><br> 
        ...
        <br><h4 style='color: orange'><?php
                ...
                <p class="mb-0">Project Deliverd: <b><?php echo $numjob; ?></b></p>
                 <br>
                 <a href="#" class="btn btn-info btn-sm" style="width: 100%; max-width: 150px;" >₹ Hire me</a>
                 <br><br>
                 <a href="#" class="btn btn-default btn-sm" style="width: 100%; max-width: 150px; border: 1px solid #aaa;">💬 Contact</a>
    ...
    <div class="col-lg-8 mb-4 mb-lg-0">
      ...
      <?php
          ...
          $sql11="SELECT * FROM products $Query11 ORDER BY product_id DESC " ;
                ...
                $img11 =$row11['product_image'];
                $tit11 =$row11['product_title'];
                $tpri11 =$row11['tprice'];
                        ...
                        if ($rating11>0 && $rating11<=5){
                            ...
                            echo "<img style='width:120px;' src='images/rat$rating11.jpg'><br>";
                          }
