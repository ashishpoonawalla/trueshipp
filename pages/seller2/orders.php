          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <tr>
                  <td><a href="http://localhost/trueshipp/pages/transporter/order_details.php">Trident</a></td>
                  <td>Internet
                    Explorer 4.0
                  </td>
                  <td>Win 95+</td>
                ...
                <tr>
                  <td><a href="http://localhost/trueshipp/pages/transporter/order_details.php">Misc</a></td>
                  <td>NetFront 3.1</td>
                ...
                <tr>
                  <td><a href="http://localhost/trueshipp/pages/transporter/order_details.php">Other browsers</a></td>
                  <td>All others</td>
                  <td>-</td>
                  <td>-</td>
                  <td>U</td>
