      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb">
            <li class="list-inline-item"><a class="h3 text-primary font-secondary" href="#">User Password Recovery</a></li>
          </ul>
      ...
      <div class="row">
        ...
        <?php 
          ...
          if(isset ($_POST['code1']) && isset ($_POST['pass11'])  && isset ($_POST['pass22'])){
            ...
            if ($pass22 != $pass11){
                echo "New password and Re-type pasword not match... <br><br><a href='UForgetPassword.php' >Goto forgot password</a>";
            }else if ($verifycode != $code1){
                echo "Code not match... <br><br><a href='UForgetPassword.php' >Goto forgot password</a>";
            }else {
                ...
                $fpuname=$_SESSION["fpuname"];                
                    ...
                    require('db.php');
                    $pass = md5($pass11);
                    $sql="UPDATE user_info SET password='$pass' Where email='$fpuname' " ;
                
                    if ($conn->query($sql) === TRUE) {
                        echo "Your password change/recover succesfully.<br><br><a href='ULogin.php'>Login Now</a>";
                    }
                    else
                    {
                        echo "Email not found... <br><br><a href='UForgetPassword.php' >Goto forgot password</a>";
                    }
            }
          }else{
        ?>
