      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb">
            <li class="list-inline-item"><a class="h3 text-primary font-secondary" href="#">Verify Transporter</a></li>
          </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <br /><br />
            ...
            <form action="TverifyCH.php" method="POST" data-form-title="Verify User">              
...
<br><br><br><br>
<a class="btn btn-success" href="TverifyResend.php"  >Resend email verify code again..</a>
