...
$numQ = 1;
$Query1=" Where status1='Posted' AND typepost='JOB' ";
      ...
      <div class="col-md-12">
        ...
        <form class="form-inline" action="Job_list.php" method="GET">
          ...
          <div class="form-group mx-sm-2 ">
            ...
            <input type="date" class="form-control" style="width: 180px;  margin-left:4px;" name="Date2" value="<?php echo $Date2 ?>" placeholder="To Date">
          </div>
          <div class="form-group mx-sm-2 ">            
         <!--   <input type="text" class="form-control" style="width: 180px;" name="cat" value="<?php echo $cat1 ?>" placeholder="To Date"> -->
          ...
          <div class="form-group mx-sm-2 ">
          <button type="submit" style="width: 150px; margin-left:4px;" class="btn btn-primary  mx-sm-2">Search</button>
          </div>
        </form>
      ...
      $result222 = $conn222->query($sql222);
        ...
        ?>
            ...
            <li class="d-md-table mb-4 w-100 border-bottom hover-shadow">
              ...
              <img class="" src="assets/images/<?php echo $pid1; ?>_1.png?t=<?php echo filemtime('assets/images/'.$pid1.'_1.png'); ?>" style="width: 350px; height: auto;" alt="trueshipp">
              <img style="position:relative; top: -19px; width: 100px;" src="images/logo50.png">  
                ...
                <a href="Job_detail.php?jobid=<?php echo $pid1; ?>" class="h4 mb-3 d-block"><?php echo $PCity; ?> to <?php echo $DCity; ?> <b style="color: #F27C00;"><?php echo $st3; ?></b> </a>
                <p class="mb-0"><b><?php echo $tit1; ?></b></p>
                <p class="mb-0" style="width: 80%; " ><?php echo $desc1; ?>.. </p>
                <div class="alert alert-danger" style="width: 40%; color: Red; " role="alert">
